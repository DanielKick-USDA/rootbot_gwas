...
filter_rep_plate <- function(
  ...
  # TODO add logic for other possible values:
  # 
  if(replicates == 'B73-10'){
    reps_vector <- 1:10
  } else if(replicates == ''){
    
  } else {
    print(paste0('"', as.character(replicates),'" has no action defined.') )
  }
...
Plate = "20190427-095354-plate_002"
...
# action
df_Removed_Seeds[df_Removed_Seeds$Plate == Plate, ]
...
# Test cases:
# 492 20220319-022909-plate_036  2.070147               N/A         missing seed 8         Y
# 509 20220326-011000-plate_046  2.024232                 4      misrep. of growth         N

Plate = "20220319-022909-plate_036" # replace
# Plate = "20220326-011000-plate_046" # drop but can't replace
...
# [X] look in the rescored folder
# [X] look for matching plate name (add csv)
# [ ] go into csv, 
#     [ ] find seed or seeds that are missing (use orig. csv to figure out what's missing)
...
# write a parser for seeds_for_removal
...
if (TRUE %in% str_detect(string = search_res, 
  ...
  df_Removed_Seeds[plate_mask, "seeds_for_removal"]
